module HazardDetectionUnit(ID_Rs, ID_Rt, ID_op, ID_funct, EX_RegDst, MEM_RegDst, EX_RegWrite, MEM_RegWrite, ControlMux, IFIDWrite, PCWrite, IFFlush, EXFlush, MEMFlush, MEM_Jump, PCSrc);
    input [4:0] ID_Rs, ID_Rt, EX_RegDst, MEM_RegDst;
    input [5:0] ID_op, ID_funct;
    input MEM_RegWrite, EX_RegWrite, MEM_Jump, PCSrc;
