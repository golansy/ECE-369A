...
# t0 - holds the last character read from the string
# t1 - acts as the index for the string to iterate through the string one character at a time
# t2 - the running total of the number of occurences of the given character (stored in t3)
# t3 - the desired character to determine the number of occurences of
#
...
con:	
 ...
 #   add     $t1, $t2, 1	    # increase indexing register $t1
 	add 	$t1, $t1, 1	#increment register $t1 (above commented out line was the error)
